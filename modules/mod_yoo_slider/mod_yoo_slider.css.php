...
if ($is_ie6 && !$is_ie7) include(PATH_ROOT . 'styles/default-h/ie6hacks.css');

if ($is_ie6 && !$is_ie7) include(PATH_ROOT . 'styles/default-h/black/ie6hacks.css');
...
if ($is_ie6 && !$is_ie7) include(PATH_ROOT . 'styles/photo-h/ie6hacks.css');
